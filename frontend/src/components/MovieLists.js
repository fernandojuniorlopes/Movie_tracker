...
const MovieLists = () => {
    ...
    useEffect(() => {
        ...
        // Set the total pages based on your data
        setTotalPages(5); // Set this to the actual total number of pages
    }, [currentPage]);
                        ...
                        <div key={movie.id} className="movie-container">
                            ...
                            <div className="movie-details">
                                <div><b>{movie.title}({movie.release_date.split("-")[0]})</b>
                                    <p><b>User score: {movie.vote_average.toFixed(2)} </b><FontAwesomeIcon style={{fontSize:"15px",paddingBottom:"2px"}} className='specific-movie-score-icon' icon={faStar} /></p>
